...
<div class="banner__text-li">
  ...
  <path d="M0 0.75H21" stroke="#AAAAAA" stroke-width="1.5"/>
        ...
        <section class="product-spec" v-for="(v,k) in productSpec" :key="k" :style="v.style.productSpec" v-if="productSpec.length>0"> 
            <!-- mobile -->
            <div class="product-spec__wrapper">
                  <div class="product-spec__content-wrapper">
      ...
      />
                ...
                <div class="product-spec__block2">
                    ...
                    <div class="product-spec__content">
                        <div class="product-spec__description">來自丹麥的 LINDBERG 承襲北歐設計的優雅精髓，以簡約美學、卓越工藝與創新技術享譽全球，丹麥擁有悠久的設計傳統，強調功能性與美感並存，這些理念深深植入 LINDBERG 的品牌哲學之中。</div>
      ...
      >
        <swiper-slide
          v-for="(item,key) in v['swiper']"
          :key="key"
          class="product-spec__slider"
        >
          <div class="product-spec__slider-item">
            <img :src="item.img" class="product-spec__swiper-img" />
      ...
      <div class="swiper-button-next-prev">
        <div class="button-prev" @click="handlesSliPrev"><svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 33 62" fill="none">
  <path d="M30.8096 1.5L2.68694 27.8231C1.12148 29.2884 1.1012 31.7657 2.64246 33.2564L30.8096 60.5" stroke="#4D4D4D" stroke-width="3" stroke-linecap="round"/>
        ...
        <div class="button-next" @click="handlesSliNext"><svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 33 62" fill="none">
