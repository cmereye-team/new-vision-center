  ...
  <div class="index">
    <div class="witness">
      ...
      <section class="section1" v-if="isPc">
        <swiper class="witnessSwiper" :modules="[Scrollbar]" :scrollbar="{
          hide: false,
        }" :slidesPerView="isPc ? 4 : 2.3" :spaceBetween="isPc ? 35 : 12" @swiper="setSwiper">
          <swiper-slide v-for="(item, index) in witness.section1" :key="index" class="witnessSwiper-slide">
              ...
              <div class="image">
                ...
                <div class="divShow">
                  <svg xmlns="http://www.w3.org/2000/svg" width="33" height="37" viewBox="0 0 33 37" fill="none">
                    ...
                    <defs>
                      <filter id="filter0_d_2534_37381" x="0.300781" y="0.154785" width="32.5547" height="36.3953"
                        ...
                        <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_2534_37381" />
                        <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_2534_37381" result="shape" />
                      </filter>
                    </defs>
                  </svg>
                </div>
    ...
    <div class="witness-user">
      ...
      <section class="section2" v-else>
        <swiper :space-between="15" :slides-per-view="1.5" :modules="[Autoplay]" :loop="true" :autoplay="{ delay: 0 }"
          :speed="4000" class="mySwiper">
      ...
      .witnessSwiper {
        &-slide {
          ...
          .content {
            position: relative;
            cursor: pointer;
            background: url("https://statichk.cmermedical.com/vision/imgs/2025021110144501.png") no-repeat;
            border-radius: 15px;
            height: 370px;
            ...
            .image::after {
              ...
              bottom: -16px;
              right: -10px;
              background: url("https://statichk.cmermedical.com/vision/imgs/2025021110395001.svg") no-repeat;
              border-radius: 15px;
              z-index: 100;
            }
          ...
          .content::before {
            ...
            position: absolute;
            z-index: 20;
            background: url("https://statichk.cmermedical.com/vision/imgs/2025021110394301.svg") no-repeat;
            right: 0;
            top: -13px;
          }
  ...
  .witness {
    ...
    .section1 {
      ...
      .witnessSwiper {
        ...
        &-slide {
          background: url(https://statichk.cmermedical.com/vision/imgs/2025021209371801.svg) no-repeat;
